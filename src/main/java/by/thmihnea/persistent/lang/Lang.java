...
public enum Lang {
    ...
    PLAYER_LEFT_YOUR_ARENA("&e(Tower Defense) &8| &f%player% left the arena. &e(%inArena%/%max%)"),
    ...
    PLAYER_JOINED_YOUR_ARENA("&e(Tower Defense) &8| &f%player% has joined the arena. &e(%inArena%/%max%)"),
    ...
    MONEY_BY_KILLING_ENTITY("&6➢ &7You've received &e%money% &7by killing a &e%entity%&7!"),
